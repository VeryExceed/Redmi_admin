<template>
	<div class="card mb-3" style="line-height: 1.2;">
		<div class="card-header d-flex align-items-center">
			...
			<!-- 上移 -->
			<el-button size="mini" icon="el-icon-top" class="ml-auto" :disabled="index === 0"
				@click="sortCart('moveUp',index)"></el-button>
			<!-- 下移 -->
			<el-button size="mini" icon="el-icon-bottom" :disabled="total === (index+1)"
				@click="sortCart('moveDown',index)"></el-button>
