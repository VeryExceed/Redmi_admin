<template>
	<div class="bg-white px-3" style="margin: -20px;margin-top: -1rem; margin-bottom: 0!important;">
		...
		<el-table border class="mt-3" :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
			...
			<el-table-column label="开票金额" prop="price" align="center">
			</el-table-column>
			<el-table-column label="抬头" prop="price" align="center">
			</el-table-column>
			<el-table-column label="发票内容" prop="content" align="center">
			</el-table-column>
