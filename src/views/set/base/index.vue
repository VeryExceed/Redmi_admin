		    ...
		    <el-tab-pane label="注册与访问" name="first">
				<el-form ref="form" :model="form" label-width="160px">
					...
					<el-form-item label="密码最小长度">
						<el-input v-model="form.password_length"
						 type="number"
						 size="mini"
						 style="width: 25%;"
						 placeholder="密码最小长度"></el-input>
					</el-form-item>
		    ...
		    <el-tab-pane label="上传设置" name="second">
				<el-form ref="form" :model="form" label-width="160px">
					...
					<el-form-item label="空间域名">
						<el-input v-model="form.http" 
						size="mini" 
						style="width: 25%;" 
						placeholder="ACCESS_KEY"
						class="text-secondary d-block">
							请补全http:// 或 https://</el-input>
					</el-form-item>
					<el-form-item>
						<el-button type="primary" size="mini">保存</el-button>
					</el-form-item>
		    ...
		    <el-tab-pane label="Api安全" name="third">
				<el-form ref="form" :model="form" label-width="160px">
					<el-form-item label="是否开启API安全">
							...
							<small class="text-secondary d-block">api安全功能开启之后调用</small>
					</el-form-item>
					<el-form-item label="秘钥">
						<el-input v-model="form.api_key" size="mini" style="width: 50%;" placeholder="秘钥"></el-input>
						<small class="text-secondary d-block">秘钥设置关系系统中api调用传输签名串编规则，以及会员token解析，请慎重设置，注意设置之后对应会员要求重新登录获取token</small>
					</el-form-item>
					<el-form-item>
						<el-button type="primary" size="mini">保存</el-button>
					</el-form-item>
