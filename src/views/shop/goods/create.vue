<template>
	<div class="bg-white px-3 goods_create">
		<router-link :to="{name:'shop_goods_list'}" class="posiab">
			...
			<el-tab-pane label="基础设置">
				<el-form ref="form" label-width="80px">
					...
					<el-form-item label="商品描述">
						<el-input v-model="desc" type="textarea" class="w-50"
					...
					<el-form-item label="总库存">
						<el-input type="number" v-model="stock" class="w-25" placeholder="">
							<template slot="append">件</template>
						</el-input>
					</el-form-item>
					<el-form-item label="库存预警">
						<el-input type="number" v-model="min_stock" class="w-25" placeholder="">
							<template slot="append">件</template>
						</el-input>
					</el-form-item>
			...
			<el-tab-pane label="商品规格">
				...
				<template v-if="skus_type === 0">
					<el-form ref="form" label-width="80px">
						...
						<el-form-item type="number" label="成本价格" class="w-25">
							<el-input v-model="stock">
								<template slot="append">元</template>
							</el-input>
						</el-form-item>
						<el-form-item type="number" label="商品重量" class="w-25">
							<el-input v-model="stock">
								<template slot="append">公斤</template>
							</el-input>
						</el-form-item>

						<el-form-item type="number" label="商品体积" class="w-25">
							<el-input v-model="stock">
						...
						<el-form-item label="添加规格">
							<div class="card">
								<div class="card-header d-flex align-items-center">
									...
									<el-button size="mini" icon="el-icon-top" class="ml-auto"></el-button>
